...
def contains_at_sign() -> RuleChecker:
    """
...
def search_regex(regex: str) -> RuleChecker:
    """
...
def fully_matches_regex(regex: str) -> RuleChecker:
    """
...
def is_phone_number() -> RuleChecker:
    """
